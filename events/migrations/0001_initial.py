        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "venue",
                    models.CharField(
                        blank=True, max_length=80, null=True, verbose_name="場所"
                    ),
                ),
                (
                    "status",
                ...
                (
                    "school",
                    models.ManyToManyField(
                        related_name="event", to="schools.School", verbose_name="対象校"
                    ),
                ),
            ],
            options={
